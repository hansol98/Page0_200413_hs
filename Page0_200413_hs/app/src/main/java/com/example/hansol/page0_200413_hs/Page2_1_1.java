...
public class Page2_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 뷰페이져와 뷰페이져 어댑터 연결
        ViewPager viewPager = findViewById(R.id.page2_1_1_viewPager);
       Page2_1_1_FragmentAdapter page2_1_1_fragmentAdapter = new Page2_1_1_FragmentAdapter(getSupportFragmentManager());
       ...
       for (int i = 0 ; i < imageList.size() ; i++) {
           Page2_1_1_ImageFragment page2_1_1_imageFragment = new Page2_1_1_ImageFragment();
           Bundle bundle = new Bundle();
           bundle.putInt("imgRes", imageList.get(i));
           page2_1_1_imageFragment.setArguments(bundle);
           page2_1_1_fragmentAdapter.addItem(page2_1_1_imageFragment);
       }
